...
TXT;
    ...
    public static function generate_analysis_on_completion($user_id)
    {
        ...
        $system = "You are a specialist assistant that generates manager-ready Employer Reports for individual team members.\n" .
            ...
            "- 'Bodily-Kinesthetic' -> 'Hands-on Execution', 'Field Operations', 'Physical Coordination', 'Action-Oriented'.\n" .
            "- 'Musical-Rhythmic' -> 'Pattern Recognition', 'Auditory Attention', 'Cadence & Timing', 'Acoustic Awareness'.\n" .
            "- 'Interpersonal' -> 'Team Leadership', 'Client Relations', 'Collaboration', 'Stakeholder Management'.\n" .
            "- 'Intrapersonal' -> 'Self-Management', 'Independent Focus', 'Resilience', 'Autonomy'.\n" .
            "- 'Naturalist' -> 'Systems Thinking', 'Environmental Awareness', 'Categorization', 'Market Ecosystems'.\n" .
            "EXAMPLE: Instead of 'High Bodily-Kinesthetic', say 'Strong aptitude for hands-on execution and field work'.\n" .
            "EXAMPLE: Instead of 'Musical Intelligence', say 'Keen ability to recognize patterns and timing'.\n\n" .

    ...
    public static function render_dashboard()
    {
        ...
        <div class="mc-dashboard-wrapper">
                    ...
                    <?php if ($linked_employer_id): ?>
                        <div class="mc-team-connected">
                            ...
                            if ($employer_logo_url):
                                ?>
                                <img src="<?php echo esc_url($employer_logo_url); ?>" alt="<?php echo esc_attr($linked_employer_name); ?> Logo" class="mc-team-logo-small">
                            <?php endif; ?>
                            <span class="mc-team-text">Linked to <strong><?php echo esc_html($linked_employer_name); ?></strong></span>
                    ...
                    <div class="mc-dashboard-main">
                                ...
                                <?php foreach ($config['steps'] as $slug): ?>
                                    ...
                                    <div class="mc-dashboard-card <?php echo $is_completed ? 'completed' : ''; ?>">
                                        ...
                                        <div class="mc-card-status">
                                            <?php if ($is_completed): ?>
                                                <span class="mc-badge success">Completed</span>
                                            <?php else: ?>
                                                <span class="mc-badge">Not Started</span>
                                            <?php endif; ?>
                                        </div>
                        ...
                        <div id="tab-experiments" class="mc-tab-content" style="display: none;">
                            <div class="mc-tab-intro">
                                ...
                                <p>Experiments are micro-actions designed to help you apply your assessment insights in the real world. Your employer or coach may assign these to help you grow specific skills or adapt to your team's needs.</p>
                            </div>
                            <?php
            ...
            <style>
                ...
                .mc-team-connected, .mc-team-invite {
                    display: flex;
                    align-items: center;
                    gap: 12px;
                    width: 100%;

                ...
                <div class="mc-container">
                    ...
                    <div class="mc-assessments-grid">
                        ...
                        <div class="mc-assessment-card">
                            ...
                            <h3>Strain Index</h3>
                            <p class="mc-card-description">Measure potential burnout and internal friction.</p>
                            <ul class="mc-card-benefits">
                                <li>Monitor emotional bandwidth</li>
                                <li>Identify burnout risks</li>
                                <li>Proactive stress management</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="mc-landing-page mc-employee-landing">
            <header class="mc-site-header">
                ...
                <div class="mc-nav">
                    <?php if (is_user_logged_in()): ?>
                        <?php
                        // Check for Employer/Admin role to show switch button
